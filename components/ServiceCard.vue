<template>
  <div
    class="main-content row align-items-center text-center justify-content-center gap-3 gap-lg-4 mb-0"
  >
    <div class="row w-100 justify-content-center gy-3 mb-3">
      ...
      >
        <nuxt-link
          to="/service"
          class="card d-flex justify-content-center align-items-center p-2 text-center h-100"
        >
          <svg
            fill="#000000"
            width="70px"
