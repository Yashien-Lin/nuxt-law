<template>
  <div
    class="main-content d-flex flex-column align-items-center justify-content-center gap-4 px-3 py-5"
  >
      ...
      >
        <div class="card h-100">
          ...
          >
            ...
            <nuxt-link to="/case" class="btn btn-primary rounded-0 text-white"
              >看更多 ...</nuxt-link
            >
          </div>
        </div>
