    ...
    >
      <div class="row g-6 main-content">
        ...
        <div
          ...
          v-for="item in memberData?.data || []"
          :key="item.id"
        >
          <div class="card h-100">
            <TheImage
              :src="config.public.apiBase + item.avatar?.url"
              :alt="item.avatar?.url"
              className="card-img-top"
            />
            <div
              class="card-body d-flex flex-column justify-content-between px-lg-4"
            >
              <div class="mb-2">
                ...
                <ul class="mb-2">
                  ...
                  <li
                    v-for="(experience, index) in item.experiences"
